...
INSTALLED_APPS = [
    ...
    # Including the providers I want to enable
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'student', 'static')]  # Try to do it with mediafis_dirs as well......
